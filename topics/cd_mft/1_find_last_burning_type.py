...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description="Prints content of registry path.")
    parser.add_argument("hive_path", help="Path to the NTUSER.DAT file.")
    parser.add_argument("key_path", help="The key path within the NTUSER.DAT hive")

    # Parse the arguments
    args = parser.parse_args()

    # Print content of RunMRU
    get_runmru(args.hive_path, args.key_path)